...
def _video_info_url(params: OrderedDict) -> str:
    vidurl = 'https://www.youtube.com/watch?v=' + params['video_id'];
    info = fetch('https://noembed.com/embed?dataType=json&url=${vidurl}').then(res => res.json()).then(data => console.log('fetch', data.title))
    print(info)
    return info
def _video_info_url(params: OrderedDict) -> str:
    print("https://youtube.com/get_video_info?" + params['video_id'])
    return "https://youtube.com/get_video_info?" + params['video_id']
#def _video_info_url(params: OrderedDict) -> str:
